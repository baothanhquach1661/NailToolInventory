        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanFulfillOnlineOrders = table.Column<bool>(type: "bit", nullable: false),
                    FulfillmentPriority = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryLevels_InventoryLocations_InventoryLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLevels_InventoryLocationId",
                table: "InventoryLevels",
                column: "InventoryLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryLevels_ProductId_InventoryLocationId",
                table: "InventoryLevels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_InventoryLocationId_CreatedAtUtc",
                table: "InventoryTransactions",
                columns: new[] { "InventoryLocationId", "CreatedAtUtc" });
